...
| 토큰 | 값 | 용도 |
|------|------|------|
| `--color-success` | `#27AE60` | 성공 상태 (시맨틱) |
...
| 토큰 | 값 | 용도 |
|------|------|------|
| `--color-score-high` | `#10B981` | 양호 (80~100) |
| `--color-score-high-bg` | `#D1FAE5` | 양호 배경 |
| `--color-score-high-text` | `#065F46` | 양호 텍스트 |
| `--color-score-mid` | `#F59E0B` | 보통 (50~79) |
| `--color-score-mid-bg` | `#FEF3C7` | 보통 배경 |
| `--color-score-mid-text` | `#92400E` | 보통 텍스트 |
| `--color-score-low` | `#EF4444` | 부족 (0~49) |
| `--color-score-low-bg` | `#FEE2E2` | 부족 배경 |
| `--color-score-low-text` | `#991B1B` | 부족 텍스트 |

### 확장 시맨틱 컬러
| 토큰 | 값 | 용도 |
|------|------|------|
| `--color-text-hint` | `#767676` | 힌트 텍스트 (WCAG AA 준수) |
| `--color-panel-bg` | `#FAFBFC` | 패널 배경 |
| `--color-highlight` | `#FDE68A` | 형광펜 하이라이트 |
| `--color-brand-text` | `#D4541C` | 오렌지 텍스트 (대비 4.6:1) |
...
### SEO 점수 컬러 (인라인 → CSS 변수 전환 진행 중)
> 위 "SEO 점수 컬러" 토큰 사용 권장. 하드코딩은 Phase 2에서 점진 교체 예정.
