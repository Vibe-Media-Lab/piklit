...
export const FEATURES = [
    ...
    },
    {
        ...
        desc: '인기 블로거의 스크린샷을 올리면 AI가 스타일을 분석하고\n내 글에도 같은 톤을 자동 적용합니다.',
        bullets: ['스크린샷만 올리면 스타일 자동 분석', '워너비(롤모델) + 내스타일(내 글) 이원화', '프리셋 저장 후 원클릭 적용'],
    },
    {
        id: 'seo',
        icon: BarChart3,
...
export const FAQS = [
    {
        q: '무료로 사용할 수 있나요?',
        a: '네, 가입 첫 달은 모든 기능을 무료로 사용할 수 있습니다. 이후에는 월 3회까지 무료 체험이 가능하며, BYOK 요금제(₩4,900/월)로 업그레이드하면 무제한으로 사용할 수 있습니다. 신용카드 등록 없이 Google 계정으로 바로 시작할 수 있습니다. 네이버, 카카오 로그인은 준비 중입니다.',
    },
    {
